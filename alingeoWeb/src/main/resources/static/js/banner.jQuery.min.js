    ...
    a.fn.extend({
        YuxiSlider: function(b) {
            ...
            return a(this).each(function() {
                ...
                g = 0,
                h = null,
                i = '<div class="desc"><p class="title desc-title"></div></div>';
                b.after(i);
                var j = a("p.title a", b),
                k = a("em.curr-num", b),
                l = a("em.total-num", b),
                ...
                p = {
                    ...
                    description: function() {
                        k.text(g + 1),
                        l.text(f),
                        j.text(e.eq(g).find("img").attr("alt")).attr("href", e.eq(g).find("a").attr("href")).width(d.width - a("span.num", b).width() )
                        $('.desc-title').text(e.eq(g).find("img").attr("alt"))
